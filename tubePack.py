...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 tubePack.py train --dataset=path/to/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 tubePack.py train --dataset=/path/to/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 tubePack.py train --dataset=/path/to/dataset --weights=imagenet

    # Apply color splash to an image
    python3 tubePack.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 tubePack.py splash --weights=last --video=<URL or path to file>
"""
